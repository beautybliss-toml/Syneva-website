    ...
    <div className="bg-[#f7f9fb] md:py-16 py-6">
      <div className="container grid p-5 mx-auto md:grid-cols-12 max-w-screen-2xl">
        ...
        <div className="md:col-span-9">
          ...
          <div className="grid items-center grid-cols-1 py-10 md:grid-cols-2 gap-7">
            <div className="">
              <img src={Staking} alt="Staking" className="w-full" />
            </div>
            <div className="row-span-2">
              <img src={Swap} alt="Swap" className="w-full" />
            </div>
            <div className="">
              <img src={Airdrop} alt="Airdrop" className="w-full" />
            </div>
          </div>
        </div>
      </div>
